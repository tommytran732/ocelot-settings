function oracle(config) {
  ...
  function wheatPrefers(potentialMatch: number, currMatch: number, preferences: any[]) {
  ...
  function traceCode(prefersFn: any) {
    return function(companies: any[], candidates: any[]) {
      ...
      function updateHires(proposal: any) {
        ...
        } else if (prefersFn(proposal.from,
