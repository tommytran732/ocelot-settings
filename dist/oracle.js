function oracle(config) {
    ...
    const obj = {
        ...
        traceWheat1: function (companies, candidates) {
            ...
            function localPrefers(potentialMatch, currMatch, preferences) {
            ...
            function updateHires(proposal) {
                ...
                else if (localPrefers(proposal.from, !proposal.fromCo ? currHire.hire.candidate : currHire.hire.company, !proposal.fromCo ? comp[proposal.to] : cand[proposal.to])) {
                    if (proposal.fromCo) {
        ...
        traceChaff1: function (companies, candidates) {
            const maxIterations = Infinity;
            const preferComp = true;
            const randomPreference = false;
            const randomProposer = false;
